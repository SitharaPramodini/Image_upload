            ...
            <div className="container mt-[8rem] max-w-full pt-3 pb-14 bg-[#f4f8fb] w-full absolute rounded-t-3xl h-auto">
                <form className="mx-8 pt-6" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center">
                        {capturedImage ? (
                            <div>
                                <img src={capturedImage} alt="Captured" className="w-40 h-40 mt-4 mx-auto" />
                    ...
                    {showCamera && (
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                            ...
                            <button onClick={() => setShowCamera(false)} className="absolute right-5 text-white bg-[#00000033] hover:bg-gray-600 p-2 rounded-full rounded-tr-none"><IoClose className="text-white"/></button>
                                ...
                                <button onClick={capturePhoto} className="text-white bg-red-700 hover:bg-red-800 px-5 py-2.5 rounded-lg mt-2"><TbCapture className="text-2xl"/></button>
                            </div>
                        </div>
                    )}
